...
class TestConfig:
    ...
    def test_load_defaults(self):
        ...
        assert config["background_mix_volume"] == 1.0
    ...
    def test_load_custom_config(self):
        ...
        assert config["background_mix_volume"] == 1.2
    ...
    def test_partial_config(self):
        ...
        assert config["background_mix_volume"] == 1.0  # Default
        assert config["background_mix_volume"] == 1.0  # Default
